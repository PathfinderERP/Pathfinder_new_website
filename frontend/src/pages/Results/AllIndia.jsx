...
export default function AllIndiaResultPage() {
    ...
    const fetchExamsAndYearsFromToppers = async () => {
        try {
            ...
            response.data.forEach((centre) => {
                if (centre.toppers && Array.isArray(centre.toppers)) {
                    centre.toppers.forEach((topper) => {
                        ...
                        // Only include All India toppers
            ...
            // Extract unique exams from All India toppers
            const uniqueExams = [...new Set(allToppers.map(t => t.exam))].sort();
            setExams(uniqueExams);

            // Extract unique years from All India toppers
            ...
            // Fallback to default exams if API fails
            setExams(['JEE', 'NEET', 'KVPY', 'NTSE']);
    ...
    return (
        <div className="relative bg-gradient-to-br pt-[56px] md:pt-32 pb-0 w-full 2xl:max-w-7xl 2xl:mx-auto shadow-sm min-h-screen">
            ...
            <div className="w-full bg-white overflow-hidden">
                <div className="w-full relative overflow-hidden aspect-[21/9] sm:aspect-[21/7] lg:aspect-[21/6]">
                    <img
                        ...
                        alt="All India Results"
                        className="w-full h-full object-cover object-center lg:object-[center_top]"
                        onError={(e) => {
                            e.target.src = "https://placehold.co/1920x600/f97316/ffffff?text=All+India+Results";
                        }}
                    />
                </div>
            </div>
            ...
            <div className="w-full bg-white">
                <div className="w-full">
                    <img
                        ...
                        alt="Toppers Showcase - All India Toppers"
            ...
            <div className="bg-black">
                <ResultsSection
                    fixedCategory="All India"
                    showTabs={false}
                    activeExam={activeExam}
                    activeYear={activeYear}
                />
                <OtherCoursesResultSection category="All India" />
                <FAQResultSection category="All India" />
