    ...
    return (
        <div className="relative bg-gradient-to-br pt-[56px] md:pt-32 pb-0 w-full 2xl:max-w-7xl 2xl:mx-auto shadow-sm min-h-screen">
            ...
            <div className="w-full bg-white overflow-hidden">
                <div className="w-full relative overflow-hidden aspect-[21/9] sm:aspect-[21/7] lg:aspect-[21/6]">
                    <img
                        ...
                        onError={(e) => {
                            e.target.src = "https://placehold.co/1920x600/f97316/ffffff?text=Board+Exam+Results";
                        }}
                    />
                </div>
            </div>
            ...
            <div className="bg-black">
                <ResultsSection
                    fixedCategory="Boards"
                    showTabs={false}
                    activeExam={activeExam}
                    activeYear={activeYear}
                />
                <OtherCoursesResultSection category="Boards" />
                <FAQResultSection category="Boards" />
