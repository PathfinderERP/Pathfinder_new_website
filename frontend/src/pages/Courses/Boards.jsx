    ...
    useEffect(() => {
        const loadPageResources = async () => {
            try {
                ...
                // 2. Filter courses to find thumbnails to preload (Boards specific logic)
                const relevantCourses = coursesData.filter((course) => {
                    ...
                    return (targetExam === 'boards' || courseName.includes("board")) &&
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-xl font-semibold text-gray-700">Loading Board Programs...</p>
