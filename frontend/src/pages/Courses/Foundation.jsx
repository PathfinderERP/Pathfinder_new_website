            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-5xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-2 bg-gradient-to-r from-orange-100 to-red-100 border border-orange-300 rounded-full mb-4 sm:mb-6 backdrop-blur-sm">
                        ...
                        <span className="text-[#66090D] text-[10px] sm:text-xs md:text-sm font-semibold uppercase tracking-wider">Foundation Programs</span>
                    </div>
                    ...
                    <p className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base lg:text-lg text-[#66090D] max-w-3xl mx-auto leading-relaxed font-medium px-4">
                        Master the fundamentals from Class 6 to 8. Expert mentorship, structured curriculum, and proven results for competitive exam success.
                    </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
                                <div className="flex items-center justify-center md:justify-start">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">Early Start</div>
                                            <div className="text-xs sm:text-sm text-gray-600">Build Strong Base</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center justify-center md:justify-start">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">NTSE/Olympiad</div>
                                            <div className="text-xs sm:text-sm text-gray-600">Special Training</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center justify-center md:justify-start lg:col-span-1 md:col-span-2 lg:md:justify-start md:justify-center">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">Small Batches</div>
                    ...
                    <div className="mt-10 sm:mt-10 md:mt-12 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto px-4">
                        {[
                            { number: "8,000+", label: "FOUNDATION STUDENTS", color: "text-red-800", icon: "👨‍🎓" },
                            { number: "92%", label: "SUCCESS IN NTSE", color: "text-orange-600", icon: "🏆" },
                            { number: "45+", label: "EXPERT MENTORS", color: "text-red-700", icon: "👨‍🏫" },
                            { number: "100+", label: "OLYMPIAD WINNERS", color: "text-orange-500", icon: "⭐" }
                        ].map((stat, index) => (
                    ...
                    <div className="mt-8 sm:mt-10 md:mt-12 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 px-4">
                        {[
                            { icon: "🧠", label: "Concept Building", bg: "bg-[#66090D]/10", text: "text-[#66090D]", border: "border-[#66090D]/20" },
                            { icon: "🎯", label: "Early Start Advantage", bg: "bg-orange-50", text: "text-orange-900", border: "border-orange-200" },
                            { icon: "👨‍🏫", label: "Personal Mentoring", bg: "bg-red-50", text: "text-red-900", border: "border-red-200" }
                        ].map((item, index) => (
                    ...
                    {/* Grade Levels */}
                    <div className="mt-12">
                        <p className="text-gray-600 mb-4 font-medium">For Grades:</p>
                        <div className="flex flex-wrap justify-center gap-3">
                            {[
                                { grade: "Class 6", color: "bg-blue-100 text-blue-800 border-blue-200" },
                                { grade: "Class 7", color: "bg-purple-100 text-purple-800 border-purple-200" },
                                { grade: "Class 8", color: "bg-green-100 text-green-800 border-green-200" },
                                { grade: "Class 9", color: "bg-yellow-100 text-yellow-800 border-yellow-200" },
                                { grade: "Class 10", color: "bg-red-100 text-red-800 border-red-200" }
                            ].map((level, index) => (
                                <div key={index} className={`px-4 py-2 rounded-lg border ${level.color} text-sm font-medium shadow-sm`}>
                                    {level.grade}
                                </div>
                            ))}
                        </div>
...
function CoursesSection({ courseType = "foundation", preFetchedCourses, preFetchedCentres }) {
            ...
            try {
                ...
                const filteredCourses = coursesData.filter((course) => {
                    ...
                    if (targetType.includes("all india") || targetType.includes("medical") || targetType.includes("engineering")) {
                        ...
                        isMatch = targetHasKeyword || nameHasKeyword || courseName.includes("all india") || courseTypeValue.includes("all india");
                    } else if (targetType.includes("board")) {
                        // Match Boards
                        isMatch = (targetExam === 'boards' || courseName.includes("board") || courseTypeValue.includes("board")) &&
                            !courseName.includes("jee") &&
                            !courseName.includes("neet") &&
                            !courseName.includes("foundation");
                    } else {
                        // Default to Foundation
                        // Strict exclusion of competitive exam keywords to prevent leakage
                        isMatch = (courseLevel === 'foundation' || courseName.includes("foundation") || targetExam === 'foundation' || courseTypeValue.includes("foundation")) &&
                            !courseName.includes("jee") &&
                            !courseName.includes("neet") &&
    ...
    const centreFilteredCourses = useMemo(() => {
        ...
        return filtered;
    }, [courses, selectedCentre, isFromApplyNow, allowedCentres]);
            ...
            <div className="mx-auto max-w-7xl px-4">
                <div className="mb-8">
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-slate-600 overflow-hidden text-ellipsis whitespace-nowrap sm:whitespace-normal">
                        Build strong fundamentals for competitive exams
                    </p>
                </div>
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center p-4">
                                            <div className="text-center">
                                                ...
                                                <div className="mt-3 bg-black/80 text-white text-xs font-semibold px-3 py-1 rounded inline-block">
                                                    {c.programme || 'FOUNDATION PROGRAM'}
                                                </div>
                                                <div className="mt-1 text-white/90 text-xs font-bold">
                                                    99% PERCENTILE ACHIEVERS
                                                </div>
                                            </div>
                                        </div>
                                    )}
...
function FeaturesAndStoriesSection() {
    ...
    const features = [
        ...
        {
            title: "Olympiad Focus",
            description: "Early exposure to Olympiad & NTSE level problems to stay ahead of the curve.",
            icon: "🏆",
            gradient: "from-purple-500 to-pink-500"
        },
        {
            title: "Logical Reasoning",
            description: "Special modules to enhance analytical and logical thinking skills.",
            icon: "🧩",
            gradient: "from-orange-500 to-red-500"
        },
        {
            title: "School Excellence",
            description: "Comprehensive coverage of school syllabus ensuring top grades in school exams.",
            icon: "🏫",
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pt-32 pb-48 md:py-24">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-8">
                        <h2 className="text-4xl md:text-5xl font-black text-black md:text-white mb-6 tracking-tight drop-shadow-sm">
                            Why Choose <span className="text-black md:text-white">Pathfinder Foundation?</span>
                        </h2>
                        ...
                        <div className="relative bg-white rounded-xl shadow-2xl pt-16 pb-16 px-4 md:px-12 mt-8 ml-4 mr-4 md:ml-0 md:mr-0 border-4 border-white">
                            ...
                            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white px-8 py-2 z-20 rounded-full border-4 border-white shadow-xl">
                                <h3 className="text-xl md:text-3xl font-black text-slate-900 uppercase whitespace-nowrap tracking-tighter">
                                    Our <span className="text-orange-500">Champions</span>
                                </h3>
                            </div>
                            ...
                            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 z-20 w-fit max-w-[90%]">
                                <div className="bg-slate-900 text-white py-3 px-6 md:px-12 rounded-xl shadow-2xl border-4 border-white relative overflow-hidden text-center">
                                    <span className="text-sm md:text-xl font-black italic tracking-widest whitespace-nowrap">
                                        <span className="text-orange-500">NTSE • OLYMPIAD • KVPY</span> RESULTS
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-slate-600">
                        Everything you need to know about the Foundation Program.
                    </p>
                </div>
