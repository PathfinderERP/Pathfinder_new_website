...
export default function AllIndiaPage() {
    ...
    useEffect(() => {
        const loadPageResources = async () => {
            try {
                ...
                // 2. Filter courses to find thumbnails to preload (All India specific logic)
                const targetType = "all india";
                const relevantCourses = coursesData.filter((course) => {
                    ...
                    return (targetHasKeyword || nameHasKeyword || courseName.includes("all india"));
                });
                ...
                const courseThumbnails = relevantCourses
                    ...
                    .slice(0, 10); // Limit to first 10 to avoid excessive loading
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-xl font-semibold text-gray-700">Loading All India Programs...</p>
...
function AllIndiaHero() {
    return (
        <section className="relative bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 pt-24 sm:pt-16 md:pt-20 pb-10 sm:pb-16 md:pb-20 overflow-hidden w-full 2xl:mx-auto 2xl:max-w-7xl 2xl:rounded-3xl 2xl:mt-10 shadow-sm">
            ...
            {/* Left Banner Image */}
            <div className="absolute left-0 top-[35%] -translate-y-1/2 hidden lg:block z-0">
                <img
            ...
            {/* Right Banner Image */}
            <div className="absolute right-0 top-[35%] -translate-y-1/2 hidden lg:block z-10">
                <img
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-5xl mx-auto">
                    {/* Badge - Using header's accent but lighter */}
                    <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-2 bg-gradient-to-r from-orange-100 to-red-100 border border-orange-300 rounded-full mb-4 sm:mb-6 backdrop-blur-sm">
                        ...
                        <span className="text-[#66090D] text-[10px] sm:text-xs md:text-sm font-semibold uppercase tracking-wider">All India Entrance Programs</span>
                    </div>

                    {/* Main Heading - Dark text for contrast */}
                    ...
                    <p className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base lg:text-lg text-[#66090D] max-w-3xl mx-auto leading-relaxed font-medium px-4">
                        Comprehensive preparation for JEE, NEET, and other national entrance exams. Expert faculty, proven strategies, and unmatched success rates.
                    </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
                                <div className="flex items-center justify-center md:justify-start">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">100% Results</div>
                                            <div className="text-xs sm:text-sm text-gray-600">Guaranteed Success</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center justify-center md:justify-start">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">Expert Faculty</div>
                                            <div className="text-xs sm:text-sm text-gray-600">IIT/AIIMS Alumni</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center justify-center md:justify-start lg:col-span-1 md:col-span-2 lg:md:justify-start md:justify-center">
                                    <div className="flex items-center gap-3 w-full max-w-[240px] md:max-w-none">
                                        ...
                                        <div className="text-left">
                                            <div className="text-lg font-bold text-gray-900 leading-tight">Live Classes</div>
                                            <div className="text-xs sm:text-sm text-gray-600">Interactive Learning</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-10 sm:mt-10 md:mt-12 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto px-4">
                        {[
                            { number: "10,000+", label: "STUDENTS ENROLLED", color: "text-orange-600", icon: "🤝" },
                            { number: "95%", label: "SUCCESS RATE", color: "text-red-800", icon: "📈" },
                            { number: "50+", label: "EXPERT FACULTY", color: "text-orange-500", icon: "👨‍🏫" },
                            { number: "42+", label: "LEARNING CENTERS", color: "text-red-700", icon: "📍" }
                        ].map((stat, index) => (
                    ...
                    <div className="mt-8 sm:mt-10 md:mt-12 flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 md:gap-6 px-4">
                        {[
                            { icon: "✓", label: "Trusted by Thousands", bg: "bg-[#66090D]/10", text: "text-[#66090D]", border: "border-[#66090D]/20" },
                            { icon: "★", label: "Top Rated Programs", bg: "bg-orange-50", text: "text-orange-900", border: "border-orange-200" },
                            { icon: "🏆", label: "Award Winning", bg: "bg-red-50", text: "text-red-900", border: "border-red-200" }
                        ].map((item, index) => (
            ...
            try {
                ...
                const filteredCourses = coursesData.filter((course) => {
                    ...
                    if (targetType.includes("all india") || targetType.includes("medical") || targetType.includes("engineering")) {
                        ...
                        // Strictly exclude "foundation" and "board" unless they are part of a specific combined course name
                        if (courseName.includes("foundation") || courseName.includes("board")) {
                            isMatch = false;
                        } else {
                            const examKeywords = ['jee', 'neet', 'cuet', 'nda', 'medical', 'engineering'];
                    ...
                    } else if (targetType.includes("foundation")) {
                        // Match Foundation
            ...
            <div className="mx-auto max-w-7xl px-4">
                <div className="mb-8">
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-slate-600 overflow-hidden text-ellipsis whitespace-nowrap sm:whitespace-normal">
                        JEE, NEET, and other national entrance exam preparation
                    </p>
                </div>
                            ...
                            >
                                ...
                                <div className="bg-black text-white p-6 flex flex-col flex-grow">
                                    ...
                                    <div className="flex items-center flex-wrap gap-3 mb-5 mt-auto">
                                        <div className="text-3xl sm:text-4xl font-bold text-orange-500 leading-none">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pt-32 pb-48 md:py-24">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-8">
                        <h2 className="text-4xl md:text-5xl font-black text-black md:text-white mb-6 tracking-tight drop-shadow-sm">
                            Why Choose <span className="text-black md:text-white">Pathfinder?</span>
                        </h2>
                            ...
                            <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 z-20 w-fit max-w-[90%]">
                                <div className="bg-slate-900 text-white py-3 px-6 md:px-12 rounded-xl shadow-2xl border-4 border-white relative overflow-hidden text-center">
                                    <span className="text-sm md:text-xl font-black italic tracking-widest whitespace-nowrap">
                                        <span className="text-orange-500">JEE • NEET • WBJEE</span> RESULTS
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-slate-600">
                        Everything you need to know about our All India Entrance Programs.
                    </p>
                </div>
