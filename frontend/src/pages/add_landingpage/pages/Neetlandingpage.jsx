...
export const Neetlandingpage = () => {
    ...
    const allCourses = useMemo(() => {
        ...
        const filtered = dataArray.filter(c => {
            ...
            const matchesNeet = name.includes('neet') || target.includes('neet') || cat.includes('neet') ||
                classLevel.includes('neet') || desc.includes('neet') ||
                name.includes('medical') || target.includes('medical') || cat.includes('medical') ||
                classLevel.includes('medical') || desc.includes('medical');
                        ...
                        {isLeadCaptured ? (
                            <div className="py-20 text-center">
                                ...
                                <p className="text-xl md:text-2xl text-gray-300 font-medium max-w-2xl mx-auto leading-relaxed">
                                    Our expert team will contact you soon to guide you through your NEET success journey.
                                </p>
                            </div>
                        ) : (
                    ...
                    <div className="max-w-6xl mx-auto px-6 relative z-10">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">
                                Related <span className="text-orange-500">NEET Courses</span>
                            </h2>
                            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                                Specialized programs designed to give you the competitive edge in NEET (UG) and other medical entrance exams.
                            </p>
                        </div>
                        ...
                        {!isLeadCaptured ? (
                            <div className="relative group">
                                ...
                                <div className="absolute inset-0 bg-white/40 backdrop-blur-md rounded-[3rem] z-20 flex flex-col items-center justify-center p-8 border-2 border-dashed border-orange-200 shadow-2xl shadow-orange-500/5">
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">View All NEET Courses</h3>
                                    <p className="text-gray-600 text-center mb-8 max-w-md font-medium">
                                        To view our complete list of Classroom and Digital programs for NEET, please complete your registration.
                                    </p>
                                    <button
                                        onClick={() => {
                                ...
                                <div className="grid grid-rows-2 grid-flow-col gap-8 animate-in fade-in slide-in-from-bottom-10 duration-1000 w-max min-w-full">
                                    {allCourses.length > 0 ? (
                                                            ...
                                                            <div className="absolute inset-0 flex items-center justify-center p-4">
                                                                <div className="text-center">
                                                                    ...
                                                                    <div className="mt-2 bg-black/80 text-white text-[10px] font-semibold px-3 py-1 rounded inline-block">
                                                                        {c.programme || 'NEET CLASSROOM PROGRAM'}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        )}
                                        ...
                                        <div className="col-span-full text-center py-10">
                                            <p className="text-gray-500 font-medium">No active NEET courses found at the moment.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 text-base md:text-lg font-semibold">
                                <span className="text-orange-500 font-black">NEET (UG)</span> &nbsp;|&nbsp; Medical Entrance Exams
                            </p>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="max-w-4xl mx-auto">
                                ...
                                {/* Additional NEET Tests Table - Separate */}
